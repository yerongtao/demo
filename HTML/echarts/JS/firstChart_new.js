/**
 * Created by yerongtao on 2017/1/20.
 */
...
window.onload = function() {
    ...
    var AcChart = echarts.init(document.getElementById('AccumulationChart'),'shine');/*绘制堆积柱形图*/
    ...
    /*----------------------------柱形图和折线图---------------------------------*/
    var itemStyle = {/*设置柱子的样式风格*/
        normal: {},/*默认状态下，使用默认样式*/
        emphasis: {/*鼠标悬停状态下，加深柱子颜色的同时设置一个阴影部分*/
            color:'#e34509',
            barBorderWidth: 1,
            shadowBlur: 20,
            shadowOffsetX: 0,
...
//                    fontSize:13
    ...
    var pieOption = {
        ...
        /* visualMap: {/!*visualMap 视觉映射组件*!/
         show: false,
         min: 100,
         max: 400,
         inRange: {
         colorLightness: [0, 1]/!*颜色明暗度*!/
         }
         },*/
        title:{/*title 图形标题*/
            text: '饼图',/*标题*/
